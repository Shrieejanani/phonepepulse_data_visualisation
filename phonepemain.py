...
icon = Image.open("phone_pe\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Janani T",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Janani T*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('phone_pe\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("phone_pe\Pulseimg.jpg")